...
copywriting_monthly = Product.create(title: "Copywriting Monthly", thumbnail_image_name: "nike-basketball-shoes-12.jpg", 
  ...
  <p><strong>What You'll Learn</strong></p>
  <ul class="no-indent">
      <li>Awesome writing</li>
      <li>What are some rules</li>
  </ul>}, author_description: %{<p>Hey, I'm Mattan Griffel, co-founder of the Y Combinator backed <a href="http://www.onemonth.com" target="_blank">One Month</a> where I teach the best selling One Month Rails and One Month Growth Hacking.</p>
                <p>Why take my class? In the past I've advised companies like Pepsico, Bloomberg, GM, NYSE, and JPMorgan on growth hacking best practices. I've also spoken at New York University, Cooper Union and First Round Capital. My goal is to help you and other entrepreneurs rapidly grow your business.
                </p>
                <p>Follow me on Twitter <a href="https://twitter.com/mattangriffel" target="_blank">@mattangriffel</a></p>})

analytics_monthly = Product.create(title: "Analytics Monthly", thumbnail_image_name: "nike_lebron12_shoe_01.jpg", header_image: "header-analytics.png", subtitle: "Ongoing Course", author: "Mattan Griffel", length:"6 months minutes", author_image_name: "teacher-image.jpg", price: "4.99", sku: "ANALYTICS2", download_url: "https://s3.amazonaws.com/stripe-payments/resume_1.pdf", details: "We'll charge you monthly for unlimited acces to our mentoring team", description: %{<p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
